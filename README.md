...
This is fork of origin migration library [goose](https://github.com/pressly/goose).

Goose-modules contains a logic to keep migrations in different folders are split by modules and allows to store it in different DB tables.

Despite on migrations can be located in different sources, goose-modules runs each of them sequentially according to their timestamp.
